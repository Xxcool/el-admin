        ...
        <el-card class="box-card">
          ...
          <div>
            ...
            <ul class="user-info">
              ...
              <li><svg-icon icon-class="phone" /> 手机号码 <div class="user-right">{{ user.phone }} <span class="themeColor" @click="$refs.phone.dialog = true"><svg-icon icon-class="edit" /></span> </div></li>
              <li><svg-icon icon-class="email" /> 用户邮箱 <div class="user-right">{{ user.email }} <span class="themeColor" @click="$refs.email.dialog = true"><svg-icon icon-class="edit" /></span> </div></li>
              <li>
