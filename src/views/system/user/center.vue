<template>
  <div class="app-container">
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="10" :lg="8" :xl="6" style="margin-bottom: 10px">
        <el-card class="box-card">
          ...
          <div>
            ...
            <ul class="user-info">
              ...
              <li><svg-icon icon-class="phone" /> 手机号码 <div class="user-right">{{ user.phone ? user.phone : '-' }} <span class="themeColor" @click="$refs.phone.dialog = true"><svg-icon icon-class="edit" /></span> </div></li>
              <li><svg-icon icon-class="email" /> 用户邮箱 <div class="user-right">{{ user.email ? user.email : '-' }} <span class="themeColor" @click="$refs.email.dialog = true"><svg-icon icon-class="edit" /></span> </div></li>
              <li>
    ...
    <updateEmail ref="email" :email="user.email ? user.email : 'null'" />
    <updatePass ref="pass" />
